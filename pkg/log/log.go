...
type Logger struct {
	...
	lvl    Level      // level for the logger
}
...
// SetLevel sets the desired log level
...
// Debug only logs if DEBUG or higher is set
...
// Info only logs if DEBUG or higher is set
